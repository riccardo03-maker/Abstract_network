...
if(__name__ == '__main__'):
    adjacency_matrix = build_adjacency_matrix(threshold = 0.7)
    save_npz("scibert_network/results/title_embeddings/title_scibert_adjacency_0_5.npz", matrix = adjacency_matrix.tocsr())
